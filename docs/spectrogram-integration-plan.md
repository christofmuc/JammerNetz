...
- Pinned spectroscope commit: `f3a08ba` (`Support JUCE OpenGL version APIs`)
...
- Analyzer and UI targets were separated, deterministic analyzer tests were added, and the
  ...
  were corrected in commits culminating in `f3a08ba`.
...
- JammerNetz pins the pushed `juce-spectroscope19/master` commit `f3a08ba`.
