...
4. Selected a deterministic healthy cadence donor and added health-based failover hysteresis so a new bursty client cannot steal cadence from an established stable source.
